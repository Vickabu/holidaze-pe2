...
const SellerPublicProfile = () => {
  ...
  if (error) return <p>Kunne ikke hente selger: {error.message}</p>;
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2 mt-4">Steder</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {user.venues.map((venue) => (
            <div key={venue.id} className="bg-gray-100 p-4 rounded shadow">
              ...
              <p className="text-sm text-gray-500">Pris per natt: ${venue.price}</p>
              <a
