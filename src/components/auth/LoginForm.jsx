 ...
 * @param {Function} props.onSuccess - Callback triggered when login is successful. Receives user data.
 *
 * @returns {React.ReactNode} A login form with role selection buttons, inputs for email and password,
 * validation error display, and a submit button.
 */
